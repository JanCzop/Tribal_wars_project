...
import com.example.tribal_wars.backend.Armies.Army_village.Army_repository;
import com.example.tribal_wars.backend.Enums.Building_type;
import com.example.tribal_wars.backend.Exceptions.Exc_building_cannot_be_constructed;
import com.example.tribal_wars.backend.Exceptions.Exc_item_not_found;
import com.example.tribal_wars.backend.Player.Player_repository;
import com.example.tribal_wars.backend.Village.Construction.Construction_service;
import com.example.tribal_wars.backend.Village.Recruitment.Recruitment_service;
import com.example.tribal_wars.backend.Village.Resources.Resources_service;
